		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pie Chart",
									"targetURL": "#piechartpiechart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"piechartpiechart-display": {
								"semanticObject": "piechartpiechart",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=piechart.piechart",
									"url": sap.ui.require.toUrl("piechart/piechart")
								}
							}
						}
					}
